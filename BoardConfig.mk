...
PB_OZIP_DECRYPT_KEY := 1c4c1ea3a12531ae491b21bb31613c11
PB_PREPARE_DATA_MEDIA_EARLY := true
PB_SKIP_COMPATIBILITY_CHECK := true
...
PB_BRIGHTNESS_PATH := "/sys/class/backlight/panel0-backlight/brightness"
PB_MAX_BRIGHTNESS := 1023
PB_DEFAULT_BRIGHTNESS := 400
PB_Y_OFFSET := 80
PB_H_OFFSET := -80
PB_THEME := portrait_hdpi
PB_INCLUDE_CRYPTO := true
PB_USE_FSCRYPT_POLICY := 1
